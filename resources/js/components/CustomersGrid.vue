        ...
        <nav aria-label="Pages" v-if="customers.length > 0">
            <ul class="pagination justify-content-center">
                <li :class="(!pagination.prev_page_url ? 'disabled ' : '') + 'page-item'">
                    <a class="page-link" @click="retrieveCustomers(pagination.prev_page_url)" aria-label="Previous">
                ...
                <li :class="(!pagination.next_page_url ? 'disabled ' : '') + 'page-item'">
                    <a class="page-link" @click="retrieveCustomers(pagination.next_page_url)" aria-label="Next">
